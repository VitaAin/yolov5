...
voc_folder = r"/Users/wangt/Downloads/dataset_reinforcing_steel_bar_counting/Annotations"  # 储存voc格式的标注文件的文件夹
yolo_folder = r"/Users/wangt/Downloads/dataset_reinforcing_steel_bar_counting/Annotations_yolo"  # 转换后的yolo格式标注文件的储存文件夹

class_id = ["rebar"]  # 储存数据集中目标种类名称的列表，接下来的转换函数中会将该列表中种类名称对应的列表索引号作为写入yolo标注文件中该类目标的种类序号
